*"* use this source file for your ABAP unit test classes^
 ...
 CLASS zcl_csd_order_overview_model DEFINITION LOCAL FRIENDS ltc_web_shop_model.                                  .
 ...
 DURATION SHORT.
   ...
   PRIVATE SECTION.
     CONSTANTS: lc_customer_number   TYPE zcsd_kd_numr_de VALUE '1',
                lc_order_number      TYPE zcsd_order_number VALUE  '1',
                lc_position_number_1 TYPE zcsd_position_number VALUE '1',
                lc_position_number_2 TYPE zcsd_position_number VALUE '2',
                lc_order_amount_1    TYPE zcsd_order_amount VALUE 01,
                lc_order_amount_2    TYPE zcsd_order_amount VALUE 02,
                mc_status_1          TYPE zcsd_status VALUE 'BE',
                mc_order_value_100   TYPE zcsd_order_value VALUE '100',
                mc_text_expception   TYPE string VALUE 'Es wurde eine Exception in der aufgerufnen Methode ausgelöst' ##NO_TEXT.

     DATA: m_cut               TYPE REF TO zcl_csd_order_overview_model,
 ...
 CLASS ltc_web_shop_model IMPLEMENTATION.
   ...
   METHOD setup.
     ...
     m_cut = NEW zcl_csd_order_overview_model( io_log = NEW zcl_csd_webshop_log( iv_object = 'ZCSD'
                                                                         iv_suobj  = 'ZCSD'  )  ).
   ...
   METHOD get_datatyp_quan.
     ...
     "given
     DATA: lv_value    TYPE  zcsd_order_amount VALUE lc_order_amount_1,
           ls_position TYPE  zcsd_order.
     "when
     TRY.
   ...
   METHOD get_datatyp_status.
     ...
     "given
     DATA: lv_value    TYPE  zcsd_status VALUE mc_status_1,
           ls_position TYPE  zcsd_order.
   ...
   METHOD get_datayp_exc_exist.
     ...
     DATA: lv_value    TYPE  zcsd_order_value VALUE mc_order_value_100,
           ls_position TYPE  zcsd_order.
     "when
     TRY.
         m_cut->change_structur_from_value( EXPORTING iv_wert        =  lv_value
   ...
   METHOD edit_position_quan.
     ...
     "given
     DATA: lv_value       TYPE          zcsd_order_amount VALUE 4.
     "when
     TRY.
   ...
   METHOD get_positions_check.
     ...
     "given
     DATA: mt_positions TYPE STANDARD TABLE OF zcsd_order WITH DEFAULT KEY .
     "when
   ...
   METHOD select_with_condition.
     ...
     "given
     DATA: mt_orders TYPE STANDARD TABLE OF zcsd_order WITH DEFAULT KEY .
     "when
     TRY.
 ...
 CLASS zcl_csd_order_overview_model DEFINITION LOCAL FRIENDS ltc_web_shop_model_artikel.
 ...
 DURATION SHORT.
   ...
   PUBLIC SECTION.
     DATA: m_cut            TYPE REF TO zcl_csd_order_overview_model,
           lt_order_data    TYPE TABLE OF zcsd_article,
           lt_artikel_preis TYPE ltt_artikel_price.

     CLASS-DATA: m_environment TYPE REF TO if_osql_test_environment.
     CONSTANTS: lc_article_number_1 TYPE zcsd_article_number VALUE 1,
                lc_price_1          TYPE zcsd_price VALUE 20,
                lc_article_number_2 TYPE zcsd_article_number VALUE 2,
                lc_price_2          TYPE zcsd_price VALUE 10.
