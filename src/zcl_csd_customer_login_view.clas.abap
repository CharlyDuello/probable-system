CLASS zcl_csd_customer_login_view DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA mo_customer_login_cntrl TYPE REF TO zcl_csd_customer_login_cntrl .

    METHODS: constructor
      IMPORTING
        !io_customer_login_cntrl TYPE REF TO zcl_csd_customer_login_cntrl ,
      call_login_screen
...
CLASS ZCL_CSD_CUSTOMER_LOGIN_VIEW IMPLEMENTATION.


  METHOD call_login_screen.
*    TRY.
        CALL FUNCTION 'ZCSD_CUSTOMER_LOGIN'
          EXPORTING
